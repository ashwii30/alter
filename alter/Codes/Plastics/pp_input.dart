...
class PpInputPage extends StatefulWidget {
  @override
  _PpInputPageState createState() => _PpInputPageState();
}

class _PpInputPageState extends State<PpInputPage> {
  ...
  Future<void> savePpData() async {
    ...
    try {
      await firestore.collection('plastics/$userId/pp').add({
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Poly Propylene Details'),
        actions: [
          TextButton(
            onPressed: () {
              savePpData();
