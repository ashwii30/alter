...
class UsedInput extends StatefulWidget {
  @override
  _UsedInputState createState() => _UsedInputState();
}

class _UsedInputState extends State<UsedInput> {
  ...
  Future<void> saveUsedData() async {
    ...
    try {
      await firestore.collection('plastics/$userId/used').add({
