...
class BottleInputPage extends StatefulWidget {
  @override
  _BottleInputPageState createState() => _BottleInputPageState();
}

class _BottleInputPageState extends State<BottleInputPage> {
  final List<String> ageOptions = [
    'Recently Bought',
    'Few months ago',
    'More than a year'
  ];
  final List<String> bottleMaterialOptions = ['Plastic', 'Glass'];
  ...
  Future<void> saveBottleData() async {
    ...
    try {
      await firestore.collection('plastics/$userId/bottles').add({
