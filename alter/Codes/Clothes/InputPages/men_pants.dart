...
class MenPants extends StatefulWidget {
  @override
  _MenPantsState createState() => _MenPantsState();
}

class _MenPantsState extends State<MenPants> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/MenPants').add({
