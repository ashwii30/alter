...
class WomenDenim extends StatefulWidget {
  @override
  _WomenDenimState createState() => _WomenDenimState();
}

class _WomenDenimState extends State<WomenDenim> {
  ...
  final List<String> MaterialOptions = ['Shirt', 'Pant', 'Trouser', 'Others'];

  String selectedAge = 'Recently Bought';
  TextEditingController quantityController = TextEditingController();
  String selectedMaterial = 'Shirt';
  String errorMessage = '';
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/women/$userId/denim').add({
