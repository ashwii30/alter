...
class WomenTshirts extends StatefulWidget {
  @override
  _WomenTshirtsState createState() => _WomenTshirtsState();
}

class _WomenTshirtsState extends State<WomenTshirts> {
  ...
  Future<void> saveData() async {
    ...
    if (user == null) {
      // Handle the case whe  re the user is not logged in.
      return;
    }
    ...
    try {
      await firestore.collection('clothes/$userId/WomenTshirts').add({
