...
class WomenShirts extends StatefulWidget {
  @override
  _WomenShirtsState createState() => _WomenShirtsState();
}

class _WomenShirtsState extends State<WomenShirts> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/WomenShirts').add({
