...
class WomenSkirts extends StatefulWidget {
  @override
  _WomenSkirtsState createState() => _WomenSkirtsState();
}

class _WomenSkirtsState extends State<WomenSkirts> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/WomenSkirts').add({
