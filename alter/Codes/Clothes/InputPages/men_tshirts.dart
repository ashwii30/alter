...
class MenTshirts extends StatefulWidget {
  @override
  _MenTshirtsState createState() => _MenTshirtsState();
}

class _MenTshirtsState extends State<MenTshirts> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/MenTshirts').add({
