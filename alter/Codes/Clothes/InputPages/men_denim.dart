...
class MenDenim extends StatefulWidget {
  @override
  _MenDenimState createState() => _MenDenimState();
}

class _MenDenimState extends State<MenDenim> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/MenDenim').add({
