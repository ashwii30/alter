...
class MenTrousers extends StatefulWidget {
  @override
  _MenTrousersState createState() => _MenTrousersState();
}

class _MenTrousersState extends State<MenTrousers> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/MenTrousers').add({
