...
class WomenShorts extends StatefulWidget {
  @override
  _WomenShortsState createState() => _WomenShortsState();
}

class _WomenShortsState extends State<WomenShorts> {
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('clothes/$userId/WomenShorts').add({
