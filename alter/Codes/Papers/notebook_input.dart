...
class NotebookInputPage extends StatefulWidget {
  @override
  _NotebookInputPageState createState() => _NotebookInputPageState();
}

class _NotebookInputPageState extends State<NotebookInputPage> {
  ...
  final List<String> NotebookMaterialOptions = [
    'Thick',
    'Thin',
  ];
  ...
  String selectedNotebookMaterial = 'Thick';
  String errorMessage = '';
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('papers/$userId/newsprint').add({
        'quantity': quantityController.text,
        'usageSpan': selectedAge,
        'paperMaterial': selectedNotebookMaterial,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton<String>(
              value: selectedNotebookMaterial,
              onChanged: (newValue) {
                setState(() {
                  selectedNotebookMaterial = newValue!;
                });
              },
              items: NotebookMaterialOptions.map((material) {
                return DropdownMenuItem<String>(
                  value: material,
                  child: Text(material),
                );
