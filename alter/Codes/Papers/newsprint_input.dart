...
class NewsprintInputPage extends StatefulWidget {
  @override
  _NewsprintInputPageState createState() => _NewsprintInputPageState();
}

class _NewsprintInputPageState extends State<NewsprintInputPage> {
  ...
  final List<String> paperMaterialOptions = [
    'Thick',
    'Thin',
  ];
  ...
  String selectedpaperMaterial = 'Thick';
  String errorMessage = '';
  ...
  Future<void> saveData() async {
    ...
    try {
      await firestore.collection('papers/$userId/newsprint').add({
        ...
        'paperMaterial': selectedpaperMaterial,
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              onChanged: (newValue) {
                setState(() {
                  selectedpaperMaterial = newValue!;
                });
              },
              items: paperMaterialOptions.map((material) {
                return DropdownMenuItem<String>(
                  value: material,
                  child: Text(material),
                );
